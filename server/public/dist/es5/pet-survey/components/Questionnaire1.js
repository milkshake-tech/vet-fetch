			...
			value: function render() {
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							Link,
							{ to: "/searchresults", className: "button small back", style: { marginLeft: 2 + "em" } },
							"Back"
						)
					),
					React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement("img", { className: "petSelection", style: { display: dogImgDisplay }, id: "dog", src: "/assets/images/dog2.png" })
									),
									React.createElement(
										"a",
										{ onClick: this.petTypeSelected, style: { borderBottom: "none", padding: "10px", cursor: "pointer" } },
										React.createElement("img", { className: "petSelection", style: { display: catImgDisplay }, id: "cat", src: "/assets/images/cat2.png" })
									)
								),
								React.createElement(
									"div",
									{ id: "nameSelection", className: displayNameCapture ? "nameSelectionVisible" : "nameSelectionNotVisible" },
									React.createElement(
										"h2",
										null,
										"Name"
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										"p",
										{ style: { margin: "10px" } },
										React.createElement("input", { style: { margin: "1em auto", borderRight: "none", borderLeft: "none", borderTop: "none", fontSize: "25px", width: "250px" }, type: "date", onChange: this.captureResponse, id: "birthday" })
									)
								),
								React.createElement(
									"div",
									...
									React.createElement(
										...
										React.createElement(
											"select",
											{ style: { margin: "auto", borderRight: "none", borderLeft: "none", borderTop: "none", fontSize: "25px", width: "180px" }, type: "text", onChange: this.captureResponse, id: "sex", defaultValue: "Select sex" },
											React.createElement(
												"option",
												{ disabled: true },
												"Select sex"
					...
					React.createElement(
						Link,
						{ to: "/survey-2", style: { marginRight: 6 + "em", float: "right" }, className: "button" },
						"Next"
					)
				);
			},
