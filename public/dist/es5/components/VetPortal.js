...
var VetPortal = (function (Component) {
	function VetPortal(props) {
		_classCallCheck(this, VetPortal);

		_get(Object.getPrototypeOf(VetPortal.prototype), "constructor", this).call(this, props);
		this.state = {
			opacitySetting: 0
		};
	}

	_inherits(VetPortal, Component);

	_prototypeProperties(VetPortal, null, {
		componentDidMount: {
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										"h2",
										null,
										"Tell us about your vetinary practice"
									),
									React.createElement(
										"p",
										null,
										"Answer a few questions about your clinic."
									)
								),
								React.createElement(
									Link,
